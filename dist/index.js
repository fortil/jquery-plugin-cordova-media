...
/***/ function(module, exports, __webpack_require__) {
	...
	function _init() {
	  ...
	  var button = $('' + this.arguments.selector);
	...
	function _chargeValues() {
	  localStorage.setItem('songs', (0, _stringify2.default)(this.songs));
	}
	...
	function _playPauseAudio(_ref2) {
	  ...
	  var id = _ref2.id,
	      ...
	      idRegistro = _ref2.idRegistro,
	      idPregunta = _ref2.idPregunta,
	      max = _ref2.max;
	  ...
	  if (this.audios[id] != undefined && this.audios[id].estado != 'pause') {
	    ...
	    this.audios[id] = new Media(fullPath, _ref3, _ref4);
	    this.audios[id].play();
	...
	function _recordAudio(_ref11) {
	  ...
	  if ((0, _keys2.default)(this.songs).length >= max) {
	...
	function _addAudio(_ref14) {
	  ...
	  this.addAudioView.bind(this)({ id: id, fullPath: fullPath, name: name, selector: selector, idRegistro: idRegistro, idPregunta: idPregunta, max: max });
	}
	...
	function _addAudioView(audio) {
	  ...
	  var reg = $('div#content-' + audio.idRegistro + '-' + audio.idPregunta);
	  ...
	  $('.remove.' + audio.id).click(function () {
	    removeAudio(audio);
	  });
	}
	...
	var App = function () {
	  function App(_ref) {
	    var idRegistro = _ref.idRegistro,
	        idPregunta = _ref.idPregunta,
	        max = _ref.max,
	    ...
	    if (localStorage.getItem('songs') != undefined && localStorage.getItem('songs') != '') this.songs = JSON.parse(localStorage.getItem('songs'));else this.songs = {};
	  }
